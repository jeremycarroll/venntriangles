...
extern FAILURE dynamicFaceIncludeVertex(FACE face, COLOR aColor, COLOR bColor, int depth);
extern bool dynamicColorRemoveFromSearch(COLOR color);
extern FAILURE dynamicFaceFinalCorrectnessChecks(void);
extern FAILURE dynamicFaceRestrictAndPropagateCycles(FACE face, CYCLESET onlyCycleSet, int depth);
...
extern FAILURE dynamicProcessIncomingEdge(EDGE edge, COLOR colors[2], int incomingEdgeSlot, int depth);
extern FAILURE dynamicHandleExistingEdge(FACE face, COLOR aColor, COLOR bColor, int depth);
