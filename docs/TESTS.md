...
Both of these labelings (ABC and ACB) have the same adjacency relationships between the faces, which are set up during the [initialization](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn3.c#L27) phase. In the tests, the initialization does not
...
There are several tests such as [testOuterFace](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn3.c#L61) and [testAbFace](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn3.c#L79) verifying the basic relationships between the faces, which are the same in both of those diagrams.
...
Being non-convex, this is excluded from our search. The exclusion is implemented in [applyMonotonicity](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/face.c#L387),
...
[24 different solutions](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn4.c#L40),
...
leaving [4 different labellings](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn4.c#L49).
...
finds the [single solution](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn4.c#L67). 
The latter has [no solutions](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn4.c#L58).
...
The code identifies the isomorphism class using [s6MaxSignature](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/s6.c#L152-L169).
...
this labelling is listed in the [test file](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn5.c#L66-L98).

These are four different 5-Venn diagrams from the same isomorphism class.

This is verified through the action of [testSearchAbcde](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn5.c#L144)
which does a complete search with duplicates for each member of the dihedral group D₅, giving 
[40 matches](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn5.c#L148-L153)
...
In [testInvert](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn5.c#L222C13-L222C23)
...
the different test scenarios. [testFullSearch](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_venn6.c#L79C13-L79C27)
...
We record each of the facial cycles in the [test data](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_known_solution.c#L29-L296). Each test 
...
[tested here](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_graphml.c#L608),
against [the corner to face mapping](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_graphml.c#L414-L426) 
read from the picture.

The [basic XML check](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_graphml.c#L606) uses a solution found in [this XML file](./645534-01-001.xml).

A more interesting solution is [this one](654444-26-0a-000.xml), or [this variation](654444-26-6c-037.xml) where there are 
[three pairs of corners with no intervening vertices](https://github.com/jeremycarroll/venntriangles/blob/35aa3295bea54def786dde3af6080e3e9a31df57/test/test_graphml.c#L388-L396).
