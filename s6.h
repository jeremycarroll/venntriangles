 ...
 * drawing the diagram on a sphere, rather than the Euclidean plane.
 * 
 * To identify a specific Venn diagram, we identify the center face by the offset.
 * Conventionally we take the cycle a,b,c,d,e,f around that face (NFACES-1),
 * and it may have been reflected from the class representative identified by
 * the classSignature.
 */
