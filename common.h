...
extern int PerFaceDegreeSolutionNumberIPC;    /* Solution number for current face set */
...
/* Output state */
extern EDGE SelectedCornersIPC[NCOLORS][3];  /* Selected corner edges for output */
...
struct graphmlFileIO {
  FILE* (*fopen)(const char* filename, const char* mode); /* File open function */
