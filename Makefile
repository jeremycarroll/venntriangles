...
TEST_SRC    = test/test_venn6.c # test/test_d6.c # test/test_venn6.c test/test_venn4.c test/test_known_solution.c test/test_venn5.c test/test_venn3.c \
...
.format: $(SRC) $(HDR) $(TEST_SRC) $(XSRC) $(D6) $(D6SRC)
	clang-format -i $?
