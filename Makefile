...
SRC		    = main.c trail.c failure.c color.c edge.c \
			  vertex.c statistics.c vsearch.c s6.c face.c utils.c memory.c graphml.c triangles.c engine.c corners.c
TEST_HELPERS = test/test_helpers.c
XSRC		= entrypoint.c
HDR			= color.h edge.h statistics.h core.h face.h main.h trail.h \
			  s6.h failure.h vertex.h vsearch.h memory.h graphml.h triangles.h engine.h corners.h
