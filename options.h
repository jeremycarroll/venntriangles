...
extern int PerFaceDegreeMaxSolutions;        // Per face degree maximum solutions (-m with -d)
extern int GlobalSkipSolutions;              // Global solutions to skip (-k)
extern int PerFaceDegreeSkipSolutions;       // Per face degree solutions to skip (-k with -d)
